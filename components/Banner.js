...
function Banner() {
    ...
    <div className="col-start-1 sm:col-start-2 md:col-start-3 lg:col-start-3 xl:col-start-3 2xl:col-start-3">
        <a
            ...
            className="flex justify-center md:justify-normal"
        >
            <button className="font-akira text-2xl md:text-3xl lg:text-5xl text-white px-5 md:px-12 py-1 border-b-2 md:ml-16 xl:ml-32 mt-10 bounce-in line-through">
                Prophex
            </button>
        </a>
    </div>
            ...
            >
                <button className="font-akira text-3xl md:text-4xl lg:text-5xl 2xl:text-6xl text-white border-b-2 pb-1 mr-10 mt-10 bounce-in">
                    Pass
                </button>
            </a>
